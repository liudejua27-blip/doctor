...
| NFR-A11Y-001 等价路径 | 2D/列表设计存在；`9fc54d4` 的文字部位 Sheet 与 `0105cd7` 的完整感觉入口均有 Simulator UI 流程覆盖，但 EVIDENCE-DEVICE-01 记录真机执行阻塞 | VoiceOver、Dynamic Type、Reduce Motion 真机 |
