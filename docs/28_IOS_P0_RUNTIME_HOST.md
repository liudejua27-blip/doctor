...
| 版本 | 0.3.14 |
| 状态 | Implemented / internal Simulator verified locally and remotely；`4cc46e2` / run `31350639359` 的 Backend/contracts、Swift 94/94、SDK build、Host boundary 与 internal Host smoke 全部成功（iPhone 16 / iOS 18.5 / Xcode 16.4）。本地 iPhone 17 Pro / iOS 26.5 targeted H015 1/0/0（77.241s）、多位置 unknown 1/0/0（49.167s）与 full Host exit 0（446.330s）。不构成生产、真机或资产批准 |
...
> **2026-08-10 H015 current evidence.** `4cc46e2` / run `31350639359` 在 iPhone 16 / iOS Simulator 18.5 / Xcode 16.4 完成全部 CI Host 步骤；本地 iPhone 17 Pro / iOS 26.5 targeted H015、多位置 unknown 与 full Host script 也通过。仅内部 Simulator，不关闭真机、无障碍、性能、碰撞、资产、签名或生产门禁。
...
历史 SHA `544c39a`、`cb5f798` 的失败 run 保留用于回溯。当前 `4cc46e2` 已保持 sibling footer、真实 count pill 的 active/empty stable ID、per-location unknown selector、中心点击与 bounded scroll；最新远端 run `31350639359` 的 Backend/contracts、Swift 94/94、SDK build、Host boundary 与 internal Host smoke 全部成功。本地 iPhone 17 Pro / iOS 26.5 targeted H015 1/0/0（77.241s）、多位置 unknown 1/0/0（49.167s）及 full Host exit 0（446.330s）。不得把 `safeAreaInset`、SwiftUI `Text` AX label/value 或 `Button` class 固定为验收 API；仍仅内部 Simulator。
...
| HOST-OPEN-002 | Simulator 可证明的 VoiceOver/Dynamic Type/Reduce Motion 最低自动化范围；`4cc46e2` 与 run `31350639359` 已通过稳定 selector、bounded scroll 和 H015 smoke；仍不声称 VoiceOver、完整 Dynamic Type 或设备辅助功能 | iOS + 无障碍 + QA | GATE-06 前 | 仅声称局部 UI smoke，不称无障碍通过 |
...
| 2026-08-10 | 0.3.14 | `4cc46e2` / run `31350639359` 的远端 Backend/contracts、Swift 94/94、SDK build、Host boundary 与 internal Host smoke 全部成功；本地 iPhone 17 Pro / iOS 26.5 targeted H015 1/0/0（77.241s）、多位置 unknown 1/0/0（49.167s）、full Host exit 0（446.330s）。仅内部 Simulator，不关闭设备/生产门禁。 |
