...
| AI 身体助手 | `AI Body Assistant` | 用户界面中的受控对话能力：围绕本次身体记录收集、整理、解释和显示审核下一步 | 不等同产品人格、真人陪诊、AI 医生或开放医疗聊天 |
...
| 身体信号报告 | `self_body_signal_report` | 面向用户自身查看的 ReportSnapshot 显示类型 | 不称病例、病历或医疗证明 |
| 就诊沟通摘要 | `clinical_communication_summary` | 用户主动选择面向医生/康复专业人员的最小字段报告显示类型 | 不代表诊断、病历、EMR 写入或专业人员已审核 |
| 训练沟通摘要 | `training_communication_summary` | 用户主动选择面向教练的最小字段报告显示类型 | 不代表复出许可、训练处方或教练已审核 |
...
| 病例 / 病历 | 身体信号报告、就诊沟通摘要或训练沟通摘要 | 产品不产生法定医疗记录、诊断或 EMR 写入 |
| AI 医生 / 陪诊医生 | AI 身体助手 | 防止暗示真人医疗服务、诊断或处方能力 |
| 做这个动作就会缓解 / 吃这个就会好 | 经审核行动的适用条件、停止条件与升级路径 | 避免疗效承诺、自由康复处方或营养治疗暗示 |
