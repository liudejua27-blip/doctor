...
按 REL-01 顺序执行：内部 Host 与历史远端 CI 基线已完成，但 HOST-T-015 的第三次测试专用修复仍须推送并等待远端重试；之后再关闭责任/地区、临床安全、Provider、身份同意数据库、真实资产与客户端、公开纵向联调、真实用户/设备验证门禁。
