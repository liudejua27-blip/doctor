...
| Git/CI | `codex/initial-git-ci-baseline`；本轮复刻切片提交 `6f232b4`；此前受保护默认分支基线 `0fa2a17`；双作业 workflow；Python 3.11 constraints | 本地可追溯基线、GitHub Actions、分支保护和 PR #1/#2 合并路径已验证；本轮提交仍需远端 CI 重建 |
